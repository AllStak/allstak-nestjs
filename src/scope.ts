/**
 * Per-request scoped context isolation for @allstak/nestjs.
 *
 ...
 * set inside an interceptor-wrapped handler does NOT leak across concurrent
 * requests, and `withScope` forks a temporary scope that is popped after the
 * callback (even on throw / rejection).
 */
